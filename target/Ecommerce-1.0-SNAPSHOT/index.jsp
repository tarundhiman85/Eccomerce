...
<div class="container text-center">
    <h1 style="color:#8c1aff">Welcome <span class="animate"></span></h1>
</div>
<div class="container">
     ...
     <%--Col:takes 12 grid--%>
      ...
      <%--Product Card--%>
                    <div class="card product-card">
                        <div class="container text-center">
                            <img src="img/products/<%=p.getpPhoto()%>" style="max-height: 150px;max-width: 100%;width: auto;" class="card-img-top m-3" alt="">
                        <div class="card-body">
                            <h5 class="card-title">
                                <%=p.getpName()%>
                            </h5>
